        ...
        <>{userData &&
            <>
                <div className={classNames(cn.picture_container)}>
                    {userData?.background && <img src='' alt='image de fond utilisateur' className={classNames(cn.backgroundPicture)} />}
                    {userData?.avatar ? <img src='' alt="avatar de l'utilisteur utilisateur" className={classNames(cn.avatarPicture)} /> : <UserCircleIcon className={classNames(cn.avatarPicture)} />}
                </div>
